   	        ...
   	        <tbody>
                ...
                <tr>
                    ...
                    <td><select name="prodi">
                            ...
                            <option value="7" <?php if ($prodi=='7') {echo "selected";} ?>>7</option>
                            <option value="8"  <?php if ($prodi=='8') {echo "selected";} ?>>8</option>
                            <option value="9" <?php if ($prodi=='9') {echo "selected";} ?>>9</option>
                    	</select>
                    </td>
                </tr>               
                <tr>
