	...
	font-family:Arial, Helvetica, sans-serif;	
			...
			<p align="center">LAPORAN DATA BUKU PERPUSTAKAAN </p>
   			<table width="100%" align="center" cellspacing="0" cellpadding="2" border="1px" class="style1">
                ...
                <td width="8%" bgcolor="#CCCCCC" align="center">Jumlah Buku</td>
                <td width="8%" bgcolor="#CCCCCC" align="center">Tanggal Input</td>
                <td width="8%" bgcolor="#CCCCCC" align="center">Status</td>
                <td width="8%" bgcolor="#CCCCCC" align="center">Keterangan</td>
              </tr>
            <?php
			...
			?>
   	        <tbody>
                ...
                <td align="center"><?php echo $data['jumlah_buku']; ?></td>
               	...
               	<td align="center"><?php echo $data['pake']; ?></td>
